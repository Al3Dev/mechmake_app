...
class DesarrolloAvanzadoProyectos extends StatefulWidget {
  @override
  _DesarrolloAvanzadoProyectosState createState() => _DesarrolloAvanzadoProyectosState();
}

class _DesarrolloAvanzadoProyectosState extends State<DesarrolloAvanzadoProyectos> {
  int _currentPage = 1;
