...
class ConsideracionesFinales extends StatefulWidget {
  @override
  _ConsideracionesFinalesState createState() => _ConsideracionesFinalesState();
}

class _ConsideracionesFinalesState extends State<ConsideracionesFinales> {
  int _currentPage = 1;
