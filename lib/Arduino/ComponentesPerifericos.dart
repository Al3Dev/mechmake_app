...
class ComponentesPerifericos extends StatefulWidget {
  @override
  _ComponentesPerifericosState createState() => _ComponentesPerifericosState();
}

class _ComponentesPerifericosState extends State<ComponentesPerifericos> {
  int _currentPage = 1;
