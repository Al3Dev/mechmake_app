...
class ProyectosPracticos extends StatefulWidget {
  @override
  _ProyectosPracticosState createState() => _ProyectosPracticosState();
}

class _ProyectosPracticosState extends State<ProyectosPracticos> {
  int _currentPage = 1;
