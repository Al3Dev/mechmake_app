...
class HistoriaEvolucionArduino extends StatefulWidget {
  @override
  _HistoriaEvolucionArduinoState createState() => _HistoriaEvolucionArduinoState();
}

class _HistoriaEvolucionArduinoState extends State<HistoriaEvolucionArduino> {
  int _currentPage = 1;
