...
class FundamentosProgramacionElectronica extends StatefulWidget {
  @override
  _FundamentosProgramacionElectronicaState createState() => _FundamentosProgramacionElectronicaState();
}

class _FundamentosProgramacionElectronicaState extends State<FundamentosProgramacionElectronica> {
  int _currentPage = 1;
