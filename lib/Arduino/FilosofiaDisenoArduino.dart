...
class FilosofiaDisenoArduino extends StatefulWidget {
  @override
  _FilosofiaDisenoArduinoState createState() => _FilosofiaDisenoArduinoState();
}

class _FilosofiaDisenoArduinoState extends State<FilosofiaDisenoArduino> {
  int _currentPage = 1;
