...
class ArquitecturaComponentesArduino extends StatefulWidget {
  @override
  _ArquitecturaComponentesArduinoState createState() => _ArquitecturaComponentesArduinoState();
}

class _ArquitecturaComponentesArduinoState extends State<ArquitecturaComponentesArduino> {
  int _currentPage = 1;
